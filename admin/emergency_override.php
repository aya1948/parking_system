...
<div class="col-md-10 p-4">
  <h4 class="fw-bold mb-4 text-danger">🚨 Emergency Vehicle Override</h4>
  <div class="alert alert-danger">
    <strong>Warning:</strong> This action will immediately cancel ALL active and upcoming reservations for the selected spot and issue full refunds. This action is logged and irreversible.
  </div>
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card border-danger">
        <div class="card-header bg-danger text-white fw-bold">Emergency Spot Override</div>
        <div class="card-body">
          <form method="POST">
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-danger w-100 fw-bold"
                    onclick="return confirm('⚠️ CONFIRM: This will cancel ALL reservations for this spot with full refunds. Proceed?')">
